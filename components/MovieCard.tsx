...
const MovieCard = ({ id, title, poster_path, vote_average, release_date, hero = false }: Movie & { hero?: boolean }) => {
    return (
        <Link href={{pathname:`/movies/[id]`, params: {id: id}}} asChild>
            <TouchableOpacity className={hero ? 'w-[80%]' : 'w-[30%]'}>
                <Image
                ...
                <View className='flex-row items-center jsutify-between'>
